...
package edu.uci.ics.crawlerbykc.fetcher;
...
import edu.uci.ics.crawlerbykc.crawler.authentication.AuthInfo;
import edu.uci.ics.crawlerbykc.crawler.authentication.BasicAuthInfo;
import edu.uci.ics.crawlerbykc.crawler.authentication.FormAuthInfo;
import edu.uci.ics.crawlerbykc.crawler.authentication.NtAuthInfo;
import edu.uci.ics.crawlerbykc.crawler.exceptions.PageBiggerThanMaxSizeException;
import edu.uci.ics.crawlerbykc.url.URLCanonicalizer;
...
public class PageFetcher {
    ...
    public PageFetcher(CrawlConfig config) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException {
        ...
        if (config.isIncludeHttpsPages()) {
            try { // Fixing: https://code.google.com/p/crawlerbykc/issues/detail?id=174
