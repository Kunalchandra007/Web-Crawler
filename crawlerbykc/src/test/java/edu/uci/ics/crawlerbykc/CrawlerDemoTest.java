...
/**
 * Test class to demonstrate Crawlerbykc functionality
 */
public class CrawlerDemoTest {

    public static class DemoCrawler extends WebCrawler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CrawlController.WebCrawlerFactory<DemoCrawler> factory = DemoCrawler::new;
