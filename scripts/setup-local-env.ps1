# Local Environment Setup - No Global Impact
# This creates a local Java 8 environment just for this project

Write-Host "=== Local crawler4j Environment Setup (No Global Impact) ===" -ForegroundColor Green
...
if (Test-Path $java8Path) {
    ...
    # Download Java 8 to local directory (smaller, faster)
