...
public class PgsqlTest {
    ...
    public static DockerComposeRule docker = DockerComposeRule.builder()
            ...
            .projectName(ProjectName.fromString("crawlerbykc"))
    ...
    public void testPostgresRepository() throws Exception {
        String jdbcurl = String.format("jdbc:postgresql://%s:%d/crawlerbykc",
    ...
    private ComboPooledDataSource getTestPool(String jdbcurl) throws PropertyVetoException {
        ...
        comboPooledDataSource.setUser("crawlerbykc");
        comboPooledDataSource.setPassword("crawlerbykc");
